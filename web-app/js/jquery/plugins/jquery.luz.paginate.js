        ...
        if (defaults.search) {
            var doSearch = function () {
                ...
                if (strSearch == "") {
                    ...
                    $(".pagination").hide();
                    rows.each(function () {
                        var tds = $(this).children("td").filter(function () {
                            var ns = strSearch.arreglar().toLowerCase();
                            var txt = $(this).text().arreglar().toLowerCase();
                            return txt.indexOf(ns) > -1;
                        }).highlight(strSearch, true);
            ...
            var $formSearch = $("<form class='form-search' style='float:" + defaults.float + ";'></form>");
            $formSearch.css({
                width : "auto"
            });
